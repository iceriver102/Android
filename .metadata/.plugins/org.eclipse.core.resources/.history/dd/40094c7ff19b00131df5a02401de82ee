...
public class reminderArrayAdapter extends ArrayAdapter<reminderData> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
					...
					public void onClick(View v) {
						...
						if (cb.isChecked()) {
							...
							if (flag) {
								...
								notifyDataSetChanged();
								MySQLiteHelper db= new MySQLiteHelper(ListView_Reminder.context);
								db.updateReminder(remind);								
								cb.setEnabled(false);
		...
		case TYPE_SEPARATOR:
			...
			final TextView txt_title_ground=(TextView) convertView.findViewById(R.id.txt_title_group);
